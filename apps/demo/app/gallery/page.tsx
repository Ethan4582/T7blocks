         ...
         <div className="min-h-screen bg-black/40 backdrop-blur-[2px]">
            <div className="mx-auto max-w-[1400px] px-6 py-12 sm:px-12 sm:py-20">
               ...
               <div className="mb-12 flex items-center gap-4">
                  <div className="relative h-12 w-12 overflow-hidden rounded-xl border border-white/10 bg-white/5 p-2 backdrop-blur-sm">
                     <Image
                        src="/assets/logo.png"
                        alt="T7 Labs Logo"
                        fill
                  ...
                  {filteredComponents.length > 0 ? (
                     filteredComponents.map((component) => (
                        ...
                        >
                           ...
                           <div className="relative aspect-[1.3/1] overflow-hidden rounded-xl bg-white/5 shadow-2xl transition-all duration-500 hover:scale-[1.02] hover:shadow-blue-500/10 border border-white/10">
                              <Image
                                 src={component.image}
                                 alt={component.name}
                                 fill
