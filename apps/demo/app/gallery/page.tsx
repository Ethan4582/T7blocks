               ...
               <div className="grid gap-x-8 gap-y-16 sm:grid-cols-2 lg:grid-cols-3">
                  {filteredComponents.length > 0 ? (
                     filteredComponents.map((component) => (
                        ...
                        >
                           <div className="relative aspect-[1.3/1] overflow-hidden rounded-xl bg-white/5 shadow-2xl transition-all duration-500 group-hover:scale-[1.02] group-hover:shadow-blue-500/10 border border-white/10">
                              <Image
                                 src={component.image}
                                 alt={component.name}
                                 fill
